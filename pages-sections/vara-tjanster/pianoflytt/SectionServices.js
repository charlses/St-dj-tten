    ...
    <div className={classes.services}>
      <GridContainer style={{ paddingTop: '30px' }}>
        <GridItem md={4} sm={4} className={classes.textCenter}>
          <InfoArea title='Tryggt' icon={Check} iconColor='rose' />
        </GridItem>
        <GridItem md={4} sm={4} className={classes.textCenter}>
          <InfoArea title='Ansvarsförsäkrade' icon={Check} iconColor='rose' />
        </GridItem>
        <GridItem md={4} sm={4} className={classes.textCenter}>
          <InfoArea title='Säkert' icon={Check} iconColor='rose' />
        </GridItem>
      </GridContainer>
    </div>
  )
