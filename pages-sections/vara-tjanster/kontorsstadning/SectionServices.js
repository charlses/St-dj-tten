    ...
    <div className={classes.services}>
      <GridContainer style={{ paddingTop: '30px' }}>
        <GridItem md={4} sm={4} className={classes.textCenter}>
          <InfoArea title='Anpassningsbara' icon={Check} iconColor='rose' />
        </GridItem>
        <GridItem md={4} sm={4} className={classes.textCenter}>
          <InfoArea title='Serviceminded' icon={Check} iconColor='rose' />
        </GridItem>
        <GridItem md={4} sm={4} className={classes.textCenter}>
          <InfoArea title='Noggranna' icon={Check} iconColor='rose' />
        </GridItem>
      </GridContainer>
    </div>
  )
